      ...
      <Tabs defaultValue="basic">
        ...
        <TabsContent value="basic" className="space-y-2">
          <div className="grid grid-cols-2 gap-2">
            <Button variant={isActive("fast") ? "default" : "outline"} onClick={() => registerScan("fast")}>
              Fast Scan <Badge className="ml-2">-F</Badge>
            </Button>
            <Button variant={isActive("ping") ? "default" : "outline"} onClick={() => registerScan("ping")}>
              Ping Scan <Badge className="ml-2">-sn</Badge>
            </Button>
            <Button variant={isActive("port") ? "default" : "outline"} onClick={() => registerScan("port")}>
              Service Scan <Badge className="ml-2">-sV</Badge>
            </Button>
            <Button variant={isActive("os") ? "default" : "outline"} onClick={() => registerScan("os")}>
        ...
        <TabsContent value="advanced" className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button variant={isActive("aggressive") ? "default" : "outline"} onClick={() => registerScan("aggressive")}>
            ...
            <Button variant={isActive("top-ports") ? "default" : "outline"} onClick={() => registerScan("top-ports")}>
              Top {advancedOptions.topPorts} Ports <Badge className="ml-2">--top-ports</Badge>
            </Button>
            <Button variant={isActive("udp") ? "default" : "outline"} onClick={() => registerScan("udp")}>
              UDP Scan <Badge className="ml-2">-sU</Badge>
            </Button>
            <Button variant={isActive("malware") ? "default" : "outline"} onClick={() => registerScan("malware")}>
              Malware Check <Badge className="ml-2">--script</Badge>
            </Button>
            <Button variant={isActive("banner") ? "default" : "outline"} onClick={() => registerScan("banner")}>
            ...
            <Button variant={isActive("http-vuln") ? "default" : "outline"} onClick={() => registerScan("http-vuln")}>
